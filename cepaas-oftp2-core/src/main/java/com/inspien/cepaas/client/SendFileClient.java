...
public class SendFileClient implements OftpClient {

    private static final Logger logger = LoggerFactory.getLogger(SendFileClient.class);

    @Override
    public void sendFile(String host, int port, String userCode, String userPassword, File payload, String destination) {
        ...
        securityCallbacks.addHandler(PasswordCallback.class, new PasswordHandler(userCode, userPassword));
