...
public class OftpServerHelper {
	...
	public static File createFile(VirtualFile vf, File tmp_dir) throws IOException {
		String filename = createVirtualFileName(vf);
		return File.createTempFile(filename + "_", null, tmp_dir);
	}
